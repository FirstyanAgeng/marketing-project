  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-800 to-red-600 text-white">
      ...
      <header className="container mx-auto py-12 px-4">
        <nav className="flex justify-between items-center mb-16">
          ...
          <div className="hidden md:flex space-x-6">
            <a href="#" className="hover:text-red-200 transition">Beranda</a>
            <a href="#" className="hover:text-red-200 transition">Film</a>
            <a href="#" className="hover:text-red-200 transition">Berita</a>
            <a href="#" className="hover:text-red-200 transition">Tentang Kami</a>
          </div>
      ...
      <section className="py-16 bg-white text-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-red-800 mb-4">Transformasi Perfilman Indonesia</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Kami memahami tantangan dalam industri film Indonesia dan berkomitmen untuk menghadirkan solusi inovatif
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="bg-red-50 p-8 rounded-lg shadow-lg transform transition hover:-translate-y-1">
              <h3 className="text-2xl font-bold text-red-800 mb-4">Tantangan Saat Ini</h3>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  <span className="text-red-500 font-bold mt-1">•</span>
                  <span>Efek visual dan CGI yang belum memenuhi standar internasional</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-red-500 font-bold mt-1">•</span>
                  <span>Konten yang kurang relevan dengan selera penonton modern</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-red-500 font-bold mt-1">•</span>
                  <span>Keragaman genre yang terbatas dan eksploitasi tema-tema serupa</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-red-500 font-bold mt-1">•</span>
                  <span>Kendala anggaran dan infrastruktur produksi yang memadai</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-red-500 font-bold mt-1">•</span>
            ...
            <div className="bg-red-50 p-8 rounded-lg shadow-lg transform transition hover:-translate-y-1">
              <h3 className="text-2xl font-bold text-red-800 mb-4">Solusi Kami</h3>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                ...
                <li className="flex items-start space-x-3">
                  <span className="text-green-500 font-bold mt-1">✓</span>
                  <span>Riset mendalam terhadap preferensi penonton kontemporer</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-green-500 font-bold mt-1">✓</span>
                  <span>Eksplorasi genre baru dan pendekatan kreatif yang segar</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-green-500 font-bold mt-1">✓</span>
                  <span>Investasi dalam teknologi dan pelatihan tenaga kerja film</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-green-500 font-bold mt-1">✓</span>
      ...
      <section className="py-16 bg-gray-100 text-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-red-800 mb-12">Proyek Unggulan Kami</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[1, 2, 3].map((item) => (
              <div key={item} className="bg-white rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                  <h3 className="font-bold text-xl mb-2">Judul Film {item}</h3>
                  <p className="text-gray-600 mb-4">
                    Deskripsi singkat tentang film ini dan bagaimana film ini menunjukkan kualitas baru perfilman Indonesia.
                  </p>
                  <button className="text-red-700 font-semibold hover:text-red-900">Pelajari Lebih Lanjut →</button>
                </div>
              </div>
            ))}
          </div>
            ...
            {[
              {
                name: "Andi Sutanto",
                role: "Sutradara Film",
                quote: "Pendekatan mereka terhadap produksi film benar-benar mengubah cara saya melihat industri film Indonesia."
              },
              {
                name: "Maya Pratiwi",
                role: "Kritikus Film",
                quote: "Jarang sekali saya melihat dedikasi seperti ini untuk meningkatkan standar perfilman nasional."
              },
              {
                name: "Budi Setiawan",
                role: "Produser Eksekutif",
                quote: "Ketelitian dan standar kualitas mereka telah menghasilkan karya yang benar-benar membanggakan."
              }
      ...
      <section className="py-16 bg-white text-gray-800">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-red-800 mb-4">Jadilah Bagian dari Revolusi Film Indonesia</h2>
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Kami mengundang Anda untuk berkolaborasi dan menjadi bagian dari perubahan industri film Indonesia
          </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white">Film</a></li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
            <p>© {new Date().getFullYear()} FilmIndonesia. Hak Cipta Dilindungi.</p>
          </div>
        </div>
      </footer>
    </div>
